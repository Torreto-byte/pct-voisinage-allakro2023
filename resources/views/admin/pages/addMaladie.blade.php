...
@section('title', 'Enregistrement maladie')
	...
	<div class="row" style="justify-content: center;">
		<div class="col-lg-8">
			<div class="card">
				...
				<form action="{{ route('postMaladie') }}" method="POST" class="form-horizontal">
					<div class="card-body card-block">
						...
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<input type="text" id="text-input" name="libelle" placeholder="nom de la maladie" class="form-control @error('libelle') is-invalid @enderror">
								@error('libelle')
