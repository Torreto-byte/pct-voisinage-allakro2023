		...
		<div class="col-md-12">
			...
			<div class="table-data__tool">
				...
				<div class="table-data__tool-right">
					<a href="{{ route('addMaladie') }}" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>Enregistrer une maladie</a>
				</div>
			</div>
							...
							<tr class="tr-shadow">
								...
								<td>
									<div class="table-data-feature">
										<a href="{{ route('editMaladie', $item->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Modifier">
											<i class="zmdi zmdi-edit"></i>
										</a>
										<form action="{{ route('supprimerMaladie', $item->id) }}" method="POST">
											@csrf
                                            @method('DELETE')
